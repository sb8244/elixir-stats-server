...
- [ ] Frontend is nice to use
  - [ ] Multiple colors per server (how to do this with many servers)
  - [ ] Single time range selection across all Charts
  - [ ] With time range selection & new data point, update the timerange end
        to the new data point, don't change beginning
  - [ ] Differentiate between servers on the scatter plots
