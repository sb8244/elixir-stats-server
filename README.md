...
- [ ] Presence sending to the client
...
3. Execute JS to send a command to the server:

```
dispatchTestCommand({ application_name: "MockServer" })
```

4. View the console output to get "2 servers" responding
